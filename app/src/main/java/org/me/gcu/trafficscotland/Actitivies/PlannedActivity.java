...
public class PlannedActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener{
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    switch (item.getItemId()) {
                        case R.id.nav_roadworks:
                            Intent a = new Intent(PlannedActivity.this, MainActivity.class);
                            startActivity(a);
                            break;
                        case R.id.nav_current_incidents:
                            Intent b = new Intent(PlannedActivity.this, CurrentActivity.class);
                            startActivity(b);
                            break;
                        case R.id.nav_planned_roadworks:
                            Intent c = new Intent(PlannedActivity.this, PlannedActivity.class);
                            startActivity(c);
                            break;
                    }
                    return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNav.getMenu().findItem(R.id.nav_planned_roadworks).setChecked(true);

        myRecyclerView = findViewById(R.id.my_recycler_view);

        PullParser_object = new PullParser("https://trafficscotland.org/rss/feeds/plannedroadworks.aspx");
